...
const SellHarvestScreen: React.FC<SellHarvestScreenProps> = ({ onHarvestSubmit, harvestRequest }) => {
    ...
    if (harvestRequest) {
        return (
            <div className="p-4 h-full flex flex-col items-center justify-center text-center bg-gradient-to-b from-white to-sky-50">
    ...
    return (
        <div className="flex flex-col h-full bg-sky-50/30">
            ...
            <form onSubmit={handleSubmit} className="flex-grow flex flex-col p-6 overflow-y-auto">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select
                                ...
                                className={`w-full p-4 bg-white border rounded-xl focus:outline-none focus:ring-2 appearance-none transition-all shadow-sm text-black ${
                                    errors.grade 
                            ...
                            >
                                ...
                                {shrimpGrades.map(g => <option key={g} value={g} className="text-black">{g}</option>)}
                            </select>
